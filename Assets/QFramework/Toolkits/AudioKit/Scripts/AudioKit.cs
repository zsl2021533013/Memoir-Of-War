...
")]
        ...
        public static void PlayMusicWithTransition(string soundName, float duration, float targetVolume = 1f)
        {
            DOTween.Sequence()
                .Append(
                    DOTween.To(
                        () => Settings.MusicVolume.Value,
                        value => Settings.MusicVolume.Value = value,
                        0f,
                        duration))
                .AppendCallback(() => PlayMusic(soundName))
                .Append(
                    DOTween.To(
                        () => Settings.MusicVolume.Value,
                        value => Settings.MusicVolume.Value = value,
        ...
        public static void StopMusicWithTransition(float duration, Action onComplete = null)
        {
            DOTween.Sequence()
                .Append(
                    DOTween.To(
