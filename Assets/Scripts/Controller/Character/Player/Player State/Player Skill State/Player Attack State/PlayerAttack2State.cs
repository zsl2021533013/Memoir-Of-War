...
{
    public class PlayerAttack2State : PlayerSkillState
    {
        public PlayerAttack2State(string animationName) : base(animationName)
        {
        }
        ...
        public override void OnUpdate()
        {
            ...
            {
                TranslateToState(controller.GetState<PlayerAttack3State>());
            }
