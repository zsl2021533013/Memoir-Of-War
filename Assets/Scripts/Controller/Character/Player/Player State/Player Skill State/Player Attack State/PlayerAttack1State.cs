...
{
    public class PlayerAttack1State : PlayerSkillState
    {
        public PlayerAttack1State(string animationName) : base(animationName)
        {
        }
        ...
        public override void OnUpdate()
        {
            ...
            {
                TranslateToState(controller.GetState<PlayerAttack2State>());
            }
