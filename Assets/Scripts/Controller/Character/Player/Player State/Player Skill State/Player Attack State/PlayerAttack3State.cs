...
{
    public class PlayerAttack3State : PlayerSkillState
    {
        public PlayerAttack3State(string animationName) : base(animationName)
        {
        }
        ...
        public override void OnUpdate()
        {
            ...
            {
                TranslateToState(controller.GetState<PlayerAttack4State>());
            }
