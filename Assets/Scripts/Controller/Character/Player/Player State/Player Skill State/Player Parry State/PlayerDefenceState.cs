...
namespace Controller.Character.Player.Player_State.Player_Skill_State.Player_Parry_State
{
    public class PlayerDefenceState : PlayerSkillState
    {
        public PlayerDefenceState(string animationName) : base(animationName)
        {
        }
        ...
        public override void OnEnter()
        {
            ...
            InputKit.Instance.DisableDefenceForSeconds(MemoirOfWarAsset.PlayerDefenceInterval);
        }
